...
const plans = [
  ...
  {
    name: 'Quiero entrar en la RAE',
    featured: true,
    price: { Monthly: '$7', Annually: '$70' },
    description:
      'You really want to integrate Spanish in your day to day improvements.',
    button: {
      label: 'Subscribe',
      href: '/register',
    },
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative">
            ...
            >
              ...
              <div className="mx-auto mt-16 grid max-w-md grid-cols-1 items-start gap-x-8 gap-y-10 sm:mt-20 lg:max-w-5xl lg:grid-cols-2">
          {plans.map((plan) => (
