...
const faqs = [
  [
        ...
        },
        {
            ...
            answer:
                "Senny's voice recognition feature transcribes your voice audio to text, allowing you to practice your Spanish pronunciation without worrying about making mistakes. The bot listens to your voice and provides an answer based on what it understood, you can ask to provide gramatical feedback on your sentences.",
        },
        {
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-2 text-lg text-gray-600">
            ...
            <Link
              href="mailto:rik@blackbearlabs.ai"
